...
def _main():
    ...
    annotation_path = 'drone_augdat_annots_train.txt'
    #annotation_path = 'Dataset/annot.txt'
    log_dir = 'logs/000/'
    ...
    if is_tiny_version:
        model = create_tiny_model(input_shape, anchors, num_classes,
            freeze_body=0, weights_path='model_data/trained_weights_stage_1.h5')
    else:
...
def create_tiny_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=0,
            weights_path='model_data/trained_weights_stage_1.h5'):
